...
def read_psl(path_to_psl, t_name_highest, q_name_highest, id_pct_highest, max_score):
...
# writes highest scored exons per contig in highest_hits.txt file
...
for entry in list_in_psl_dir:
    if fnmatch.fnmatch(entry, pattern):
        ...
        t_name_highest, q_name_highest, id_pct_highest, max_score = \
            read_psl(path_to_psl, t_name_highest, q_name_highest, id_pct_highest, max_score)

        # creates a highest_hits.txt file where all highest BLAT hits are written per contig per species
